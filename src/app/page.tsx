...
export default function HomePage() {
  const { records, loading, error, dailyDelta } = useMockCarbonData()
  ...
  const categoryStats = useMemo(() => deriveCategoryStats(records), [records])
  ...
  return (
    <main className='min-h-screen bg-background-muted py-4 px-3'>
      <div className='mx-auto max-w-sm'>
        ...
        <CategoryBreakdown categoryStats={categoryStats} totalCO2={totalCO2} />
        <RecentRecords
          loading={loading}
          records={records}
