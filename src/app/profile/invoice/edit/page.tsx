		...
		<main className='min-h-screen bg-blue-50/30 px-3 py-4'>
			<div className='mx-auto max-w-sm'>
				...
				<div className='mb-6'>
					<Link
						href='/profile'
						className='mb-4 inline-flex items-center text-primary-600 text-xs hover:text-primary-700'
					>
						← 返回個人資料
					</Link>
					<h1 className='mb-1 text-foreground-primary text-h1'>編輯發票資訊</h1>
				</div>
				...
				<form onSubmit={handleSubmit} className='space-y-6'>
						...
						<div className='space-y-4'>
							...
							<div>
								<label
									...
									className='mb-1.5 block font-semibold text-body text-foreground-primary'
								>
									發票帳號
								</label>
								<input
					...
					<button
						...
						className='w-full rounded-lg bg-primary-500 px-4 py-3 font-semibold text-body text-white transition-colors hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-200 disabled:bg-disabled disabled:text-foreground-muted'
					>
